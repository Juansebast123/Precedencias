...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\63\13\4\3\4\2\3\6\5\2\4\6\2\4\3\2\7\b\3\2\t\n\2;\2\t")
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << LabeledExprParser.T__1) | (1 << LabeledExprParser.ID) | (1 << LabeledExprParser.FLOAT) | (1 << LabeledExprParser.INT) | (1 << LabeledExprParser.NEWLINE))) != 0)):
                    break
